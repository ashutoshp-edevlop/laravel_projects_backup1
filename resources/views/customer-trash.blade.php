...
<html lang="en">
  ...
  <div class="container-fluid bg-dark">
    ...
    <a href="{{url('customer/view')}}" class="bg-primary text-white" style="border: 1px solid black; padding: 5px; box-sizing: border-box; float: right; height: 50px; width: 270px; font-size: 30px; margin:10px; border-radius:5px;">BacK To Customer</a>
    <form action="">
  ...
  @endif</td>
            <td>@if($customer->dob == "")
              Not Mentioned
              @else
              {{get_formatted_data($customer->dob,"d-M-Y")}}
              @endif
            </td>
