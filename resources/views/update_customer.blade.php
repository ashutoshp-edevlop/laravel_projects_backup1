        ...
        <div class="contianer card p-3 bg-white">
            ...
            <div class="row">
                <div class="form-group col-md-6 required">
                  ...
                  <input type="text" name="name" id="" class="form-control" value="{{$customer->name}}" placeholder="Enter your name..." aria-describedby="helpId">
                ...
                <div class="form-group col-md-6 required">
                  ...
                  <input type="text" name="email" id="" class="form-control" value="{{$customer->email}}" placeholder="Enter your email..." aria-describedby="helpId">
                  <span class="text-denger">
                    @error('email')
                    {{$message}}
                    @enderror
            ...
            <div class="row">
                <div class="form-group col-md-6 required">
                  ...
                  <input type="text" name="country" id="" class="form-control" value="{{$customer->country}}" placeholder="Enter your country name..." aria-describedby="helpId">
                  <span class="text-denger">
                    @error('country')
                    {{$message}}
                    @enderror
                ...
                <div class="form-group col-md-6 required">
                  ...
                  <input type="text" name="state" id="" class="form-control" value="{{$customer->state}}"  placeholder="Enter your state name..." aria-describedby="helpId">
                  <span class="text-denger">
                    @error('state')
                    {{$message}}
                    @enderror
            ...
            <div class="row">
                <div class="form-group col-md-12 required">
                  ...
                  <input type="text" name="address" id="" class="form-control" value="{{$customer->address}}" placeholder="Enter your address..." aria-describedby="helpId">
                  <span class="text-denger">
                    @error('address')
                    {{$message}}
                    @enderror
